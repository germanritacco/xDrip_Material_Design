...
public class FirstPageFragment extends Fragment {
    ...
    public class ViewStats { // Linking to stats_general layout
        ...
        public boolean viewGviLine() { // Show the GVI line
            return Pref.getBoolean("show_statistics_gvi", false);
        }

        public boolean viewPgsLine() { // Show the PGS line
            return Pref.getBoolean("show_statistics_pgs", false);
        }
    }
        ...
        public void run() {
            ...
            if (bgList.size() > 0) {
               ...
               /* if (Pref.getBoolean("show_statistics_pgs", false) && Pref.getBoolean("show_statistics_gvi", true)) { // Show both GVI and PGS
                ...
                if (Pref.getBoolean("show_statistics_gvi", true)) { // Show only GVI
                    if (gvi >= 1.0 && gvi <= 1.2) {
                ...
                if (Pref.getBoolean("show_statistics_pgs", false)) { // Show only PGS
                    if (PGS >= 0 && PGS < 35) {
